	...
	if($_SESSION["Permisos_Eneaware"][6]!="000"){
		...
		if($_POST['accion']=="imprimir"){
			...
			<div  style="font-family:Arial;margin:auto;padding:1cm;background:white;width:21.59cm;border:1px solid grey; height:27.94cm">				
				...
				<b>Fecha de Inicio</b>'.$fechaIni.' <b style="">Fecha de Termino</b> '; echo $termino = ($fechaFinal!="0000-00-00") ? $fechaFinal : "Aun sin terminar"; 
				echo'			

				<table  style="position:relative;top:5%;">

					<tr id="encabezado" style="color:white;" bgcolor="#000000"> 
					...
					while($datosImp = @mysqli_fetch_assoc($imp)){
						...
						echo'
						<tr style="position:relative;top:15%;">
							<td style="border-left: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000;text-align:center;">
								'.$result['nombre'].'					
							</td>
							...
							<td width=10 style="border-bottom: 1px solid #000;border-right: 1px solid #000;text-align:center;">
								'.$datosImp['notas'].'
							</td>
							<td style="border-bottom: 1px solid #000;border-right: 1px solid #000;text-align:center;">';
		...
		if($_POST['accion']=="ver"){
			...
			<table style="position:relative;left:2%;" >
				<tr style="background:black;color:white;"> 
					...
					<table id="resultados" style="position:relative;left:1%;">';
